...
module.exports = Any.extend({
    ...
    messages: {
        ...
        'object.assert': '{{#label}} no es válido porque {if(#subject.key, `"` + #subject.key + `" no pudo ` + (#message || "pasar la prueba de aserción" ), #mensaje || "la afirmación falló")}',
        ...
        'object.max': '{{#label}} debe tener menos o igual que {{#limit}} key{if(#limit == 1, "", "s")}',
        ...
        'object.pattern.match': '{{#label}} claves no cumplieron con los requisitos del patrón',
        'object.refType': '{{#label}} debe ser una referencia de Joi',
        'object.regex': '{{#label}} debe ser un objeto RegExp',
        'object.rename.multiple': '{{#label}} no puede cambiar el nombre de {{:#from}} porque varios cambios de nombre están deshabilitados y ya se cambió el nombre de otra clave a {{:#to}}',
        'object.rename.override': '{{#label}} no puede cambiar el nombre de {{:#from}} porque la anulación está deshabilitada y el objetivo {{:#to}} existe',
        'object.schema': '{{#label}} debe ser un esquema Joi de tipo {{#type}}',
        'object.unknown': '{{#label}} no está permitido',
        'object.with': '{{:#mainWithLabel}} falta el par requerido {{:#peerWithLabel}}',
        'object.without': '{{:#mainWithLabel}} conflicto con el par prohibido {{:#peerWithLabel}}',
