...
module.exports = Any.extend({
    ...
    messages: {
        'array.base': '{{#label}} debe ser una matriz',
        ...
        'array.includesRequiredUnknowns': '{{#label}} no contiene {{#unknownMisses}} valores requeridos',
        ...
        'array.sort': '{{#label}} debe ordenarse en orden {#order} por {{#by}}',
        'array.sort.mismatching': '{{#label}} no se puede ordenar debido a tipos que no coinciden',
        'array.sort.unsupported': '{{#label}} no se puede ordenar debido a un tipo no admitido {#type}',
