...
module.exports = Any.extend({
    ...
    messages: {
        ...
        'string.hexAlign': '{{#label}} representación decodificada hexadecimal debe estar alineada en bytes',
        ...
        'string.length': 'La longitud de {{#label}} debe tener {{#limit}} caracteres',
